  ...
  return (
    ...
    <Row className= 'd-flex flex-row mt-3'>
        <Col xxl={3}  xl={3}  lg={3}  md={3}  sm={6}  xs={6} className='text-center d-flex flex-column align-items-center col'>
            ...
            <span className='d-flex flex-column'> <Icon icon="logos:sass" width="110" height="100" />Sass</span>
        </Col>
        <Col xxl={3}  xl={3}  lg={3}  md={3}  sm={6}  xs={6} className='text-center d-flex flex-column align-items-center col'>
            ...
            <span className='d-flex flex-column'> <Icon icon="logos:heroku-icon" width="110" height="100" />Heroku</span>
        </Col>
        <Col xxl={3}  xl={3}  lg={3}  md={3}  sm={6}  xs={6} className='text-center d-flex flex-column align-items-center col'>
